...
The percentage of the population > 65 has a few outliers on each end. It appears that `Fatality_Rate` and % of 65+ have a postiive correlation up to a certain point (~17.5% or so). No combination of log transformations makes a more linear relationship between the two variables. % of 65+ is relatively normally distributed. 
...
diabetes_scatter_log <- df %>%
  ggplot() +
  aes(log(Diabetes_Diagnosed_Perc), Fatality_Rate) +
  geom_point() + geom_smooth()
