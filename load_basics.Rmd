...
merge_sum <- aggregate(x = merge5, by = "state", FUN = sum)

# c(cases, state, deaths, Staffed.All.Beds, Staffed.ICU.Beds, Population, Population..20.., Population..65.., num_diabetes_diagnosed, Staffed_ICU_Beds_Elderly, Staffed_ICU_Beds_People, Staffed_ICU_Beds_Adults, Asthma_Deaths, Obesity, Stroke_Deaths, Heart_Disease_Deaths, Smoking, Chronic_Respiratory_Disease_Deaths, Unemployment, Minority, Crowding, Multi_Unit, Poverty)~ state, sum
#   v1 <- aggregate(  ~ state, data = df, sum)
