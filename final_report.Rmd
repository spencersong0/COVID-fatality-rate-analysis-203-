...
```{r, echo=FALSE, warning = FALSE, message = FALSE, fig.cap="Scatterplots for each explanatory variable vs Fatality Rate", fig.pos='!h', out.extra='', fig.align="center"}
